	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-9 p-0">
				<div class="card">
					<div class="card-body">
						<p class="fs-3 text-center">Paintings</p>
						...
						<div class="row">
							...
							String sql = null;
							if ("all".equals(cat)) {
								sql = "select * from painting order by id desc";
							} else {
								sql = "select * from painting where category='" + cat + "' order by id desc";
							}

							List<Paintings> list2 = dao.getPaintByCategory(sql);
