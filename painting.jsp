...
<title>Artist | Add Paintings</title>
...
<body>
	...
	<div class="conatiner text-center p-3 bg-light">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Add Paintings</p>
			...
			<div class="col-md-8">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Painting Details</p>
